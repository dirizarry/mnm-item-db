...
def main() -> int:
    ...
    ap.add_argument("--no-site", action="store_true", help="Skip site bundles (ledger extract only)")
    ...
    ap.add_argument("--upload-dry-run", action="store_true", help="Write data/ledger-upload-payload.json")
